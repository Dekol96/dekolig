...
USN="Mozilla/5.0 (Linux; Android 7.1.2; 17MB150WB Build/NZH54D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/72.0.3626.121 Safari/537.36 Instagram 166.1.0.42.245 Android (29/10; 420dpi; 1080x2042; samsung; SM-G973F; beyond1; exynos9820; en_GB; 256099204)"
internal=[]
external=[]
success=[]
checkpoint=[]
...
{H}[*] Email       : merspam190@gmail.com
{H}[*] Bergabung   : 26 November 1945
{H}[*] ---------------------------------------------
{H}[*] Kadaluwarsa : 085894046780
{H}[*] Status      : Premium Sampe Kiamat
{H}[*] Author      : Dekol bekasi
{H}[*] ---------------------------------------------
